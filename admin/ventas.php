...
.sidebar a:hover { background: #007bff; } /* Esto es AZUL (Estilo Admin) */
...
<div class="sidebar" style="background: #343a40;"> <h4 class="text-white text-center">Admin Panel</h4>
    <a href="dashboard.php">🏠 Dashboard</a>
    <a href="productos.php">📦 Gestión Productos</a>
    <a href="ventas.php">💰 Registrar Venta</a>
    <a href="salarios.php">📊 Ver Salarios</a>
